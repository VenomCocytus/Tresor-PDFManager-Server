package com.venomclasses.tresorseen.controller;

import com.venomclasses.tresorseen.entity.FileDB;
import com.venomclasses.tresorseen.response.ResponseFile;
import com.venomclasses.tresorseen.response.ResponseMessage;
import com.venomclasses.tresorseen.service.FileStorageService;
import com.venomclasses.tresorseen.util.FileUtils;
...
public class FileController {
    ...
    public ResponseEntity<String> renameFileByName(@PathVariable String filename, @RequestParam("newName") String newName) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body("The file, " + filename + " have been renamed successfully into: " + renamedFile.getFileName());
        } catch (Exception e) {
